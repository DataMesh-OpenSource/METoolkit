...
namespace DataMesh.AR.Library
{
    ...
    {
        private static LibraryAssetManager _instance;
        public static LibraryAssetManager Instance
        {
            get
            {
                if (_instance == null)
                    _instance = new LibraryAssetManager();
                return _instance;
            }
        }

        private Dictionary<string, LibraryAssetData> storageAssetDic = new Dictionary<string, LibraryAssetData>();

        private LibraryAssetManager() { }
        ...
        /// <param name="fileName"></param>
        /// <returns></returns>
        public LibraryAssetData LoadAsset(string fileName)
        {
            string filePath = LibraryManager.GetFilePath() + fileName;
            ...
            LibraryAssetData data = DecryptAsset(bytes);
        ...
        public void ReleaseAsset(LibraryAssetData data)
        {
