...
namespace DataMesh.AR.SpectatorView
{
    public class ShaderManager : MonoBehaviour
    {
        ...
        void OnEnable()
        {
            ...
            alphaBlendVideoMat.SetFloat("_Alpha", LiveParam.Alpha);
            alphaBlendPreviewMat.SetFloat("_Alpha", LiveParam.Alpha);
            alphaBlendOutputMat.SetFloat("_Alpha", LiveParam.Alpha);
