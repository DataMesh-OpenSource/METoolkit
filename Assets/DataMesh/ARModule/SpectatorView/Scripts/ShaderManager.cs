...
namespace DataMesh.AR.SpectatorView
{
    public class ShaderManager : MonoBehaviour
    {
        ...
        void OnEnable()
        {
            ...
            alphaBlendVideoMat.SetFloat("_Alpha", LiveController.Instance.alpha);
            alphaBlendPreviewMat.SetFloat("_Alpha", LiveController.Instance.alpha);
            alphaBlendOutputMat.SetFloat("_Alpha", LiveController.Instance.alpha);
        ...
        private void SetupCamera(Camera camera, int rtWidth, int rtHeight, out RenderTexture renderTexture)
        {
            ...
            renderTexture = new RenderTexture(rtWidth, rtHeight, (int)holoCamera.TextureDepth);
            renderTexture.antiAliasing = (int)holoCamera.AntiAliasing;
            renderTexture.anisoLevel = 0;
            renderTexture.filterMode = holoCamera.Filter;
        ...
        private void SetupCameraValues(Camera camera)
        {
            ...
            camera.fieldOfView = calibration.DSLR_fov.y;
            camera.enabled = true;
        }
